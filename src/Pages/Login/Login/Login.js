    ...
    return (
        ...
        <div className="text-white w-full max-w-md p-4 rounded-md shadow bg-teal-800 mx-auto m-10">
            ...
            <div className="my-6 space-y-4">
                <Link ><button onClick={handleGoogleSignIn} type="button" className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 dark:border-gray-400 focus:ring-purple-400">
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                        <div className="flex justify-between">
                            ...
                            <Link onClick={handlePasswordChange} className="text-xs hover:underline dark:text-gray-400">Forgot Your Password?</Link>
                        </div>
